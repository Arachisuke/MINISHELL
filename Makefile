...
SRC = $(SRC_DIR)/fonction.c $(SRC_DIR)/main.c $(SRC_DIR)/init_node.c \
	  ...
	  $(BUILTIN_DIR)/exit.c $(BUILTIN_DIR)/pwd.c $(EXEC_DIR)/here_doc.c $(EXEC_DIR)/open_and_close.c \
	  $(EXEC_DIR)/pipex_process.c $(EXEC_DIR)/pipex.c $(EXEC_DIR)/utils.c $(EXEC_DIR)/utils2.c
